...
tippecanoe \
 --output=./output/intermediate-steps/Bietigheim-Bissingen-poi-areas-ways.mbtiles \
 --force \
 --minimum-zoom=7 \
 --maximum-zoom=16 \
 --simplification=10 \
...
tippecanoe \
 --output=./output/intermediate-steps/Bietigheim-Bissingen-poi-points.mbtiles \
 --force \
 --minimum-zoom=7 \
 --maximum-zoom=16 \
 -r1 \
...
tile-join  --force -o ./output/Bietigheim-Bissingen-poi-merged.mbtiles ./output/intermediate-steps/Bietigheim-Bissingen-poi-areas-ways.mbtiles ./output/intermediate-steps/Bietigheim-Bissingen-poi-points.mbtiles
