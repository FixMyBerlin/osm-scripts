export const netlifyFileUrl = (dirnameString: string) => {
  // `dirnameString` looks like `/Users/NAME/FOLDER/osm-scripts/Bietigheim-Bissingen/POI-PublicTransport/output/poiPublicTransport.geojson`

  // Cleanup:
  // `__dirname` inside this file looks like `/Users/NAME/FOLDER/osm-scripts/Bietigheim-Bissingen/utils`
